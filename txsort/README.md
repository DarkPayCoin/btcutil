...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/DarkPayCoin/btcutil/txsort)
...
```bash
$ go get -u github.com/DarkPayCoin/btcutil/txsort
```
